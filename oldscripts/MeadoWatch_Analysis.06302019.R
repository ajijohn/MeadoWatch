...
PhenoDat <- read.csv("./data/MW_PhenoDat_2013_2018.csv", header=TRUE) #phenology data
StationDat <- read.csv("./data/MW_SiteDat_2013_2018.csv", header=TRUE) #information about station
...
for(i in 1:length(species)){
  ...
  for(j in 1:length(phenocats)){ #now by phenophase
    ...
    #Analysis: right now nothing happens to this, ideally would be saved
