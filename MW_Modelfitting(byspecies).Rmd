...
```
#Appendix F: One figure, multi-panel of the same results (for Appendix G)
...
#extract species
#species <- pars_spp_peak$species
par(mfrow=c(4,4), omi=c(0,0,0,0), mai=c(0.25,0.25,0.25,0.1), 
      tck=-0.02, mgp=c(1.0,0.2,0), din=c(5,5), pty="s")
