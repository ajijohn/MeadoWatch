...
dimnames(pars_QAQC) <- list(c(), c("year","transect","site_code","plot",
                                      "SDD","species","peak_Q","duration_Q","max_Q"))
...
#merge with pars_yrpltsp
pars_comp <- merge(pars_QAQC, pars_yrpltsp, by=c("year","transect","site_code",
                                                 "plot","species","SDD"))
...
###########
ODDS AND ENDS BELOW (mostly figures)
