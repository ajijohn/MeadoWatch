...
=======
#Identify potentially problematic data (data + curves) - Aji first version done 10/26
##plots with outliers
##limited sampling early / late
## Defnitely species wit peak flowering dates that are outside conventional range
```{r}
plot_pars_years <- read.csv("data/PerPlotCurves.csv", header=TRUE) 
...
ggsave("figs/sanity_check.png", width = 30, height = 20, units = "cm")

``` 
#Extract SDD data from raw files
>>>>>>> f610d6309794d89ce084e3a3b0c9239ffe1a3c5e
