...
1. Pulls out data for each species / plot / year combo. Data in innermost loop is PhenoSite_YearPlotSpecies. Note - fitting only occurs if sufficient data, as defined by these two parameters (you can modify them):
   + *totobs* (# observations for fitting, set at 20)
...
#TODO Another option is to plot AIC null vs. AIC alt of all combos, and the 1:1 line. This should show most if not all AIC alt are less than AIC null. Could color code / change shapes depending on years / species
```{r}
#Make a plot showing...
