...
Create graphs showing observation effort across the growing season
```{r}
# Read in data
...
for(i in 1:2){
  ...
  plot(1,1, type="n", xlim=c(minDOY, maxDOY), ylim=c(0,(nyr_trail+2)), yaxt="n",
  ...
  for(j in yr1:yr2){
    ...
    #labels
    xposlab <- minDOY - (maxDOY-minDOY)*1/15
