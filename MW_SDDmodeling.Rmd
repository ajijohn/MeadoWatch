...
This code chunk reads in SDD data from MeadoWatch, Forest Demography, Elli's phenology plots, and Meera's phenology / herbivory plots. Some observations are removed due to data issues (those with faulty hobo's) in Meera and the FD dataset. Additionally, data from years not covered by the MeadoWatch data set are removed from Elli's data. Finally, the FD data set was pared down to only include higher elevation stands (above 1000 meters) and stands closer by the trails (SW and NE parts of the park)
```{r}
