...
plot(c(6,1), type="n", xaxt="n", xlim=c(3.5,9.5), ylim=c(0,0.5),
     xlab="Month", ylab="Trip Reports")
title("WTA Trip Reports")
...
plot(c(6,1), type="n", xaxt="n", xlim=c(3.5,9.5), ylim=c(0,0.8),
     xlab="Month", ylab="Peak Flowering")
title("MeadoWatch Peak Flowering")
...
This code chunk:
1. Reads in WTA data
2. Average across reviewers (after omitting NA)
3. RandomForests to examine relationship among sentiments
...
#Now analysis relating Sentiment to flowering
